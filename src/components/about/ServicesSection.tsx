...
export const servicesData: ServiceItemData[] = [
  ...
  },
  {
    ...
    skills: ["MULTI-TENANT", "BILLING", "AUTH SYSTEMS", "DASHBOARDS"],
    sarcasticQuote: "Building products nobody asked for and charging them monthly for it.",
  },
  {
    id: "ai",
    number: "05",
    title: "AI INTEGRATION & AUTOMATION",
    skills: ["LLM APIS", "AI WORKFLOWS", "PROMPT ENGINEERING", "AGENTS"],
    sarcasticQuote: "Letting robots do my job while I take the credit and the paycheck.",
  },
  {
    id: "cms",
    number: "06",
